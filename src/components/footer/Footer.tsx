...
const Footer = () => {
  return (
    <footer className="md:mx-[10.417%] md:pb-20 md:-mt-5 md:pt-32 pt-12 pb-16">
      <div className='flex md:flex-row flex-col-reverse lg:gap-[30px]'>
        <div className='md:w-[263px] gap-y-4 md:gap-y-7 flex md:flex-none flex-col justify-center md:justify-start md:items-start items-center pl-6 md:pl-0 pr-[33px] md:pr-0'>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 md:gap-[30px] justify-around pl-6 md:pl-0">
